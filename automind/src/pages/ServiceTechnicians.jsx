...
const technicians = [
  { id: 1, name: "Robert Chen", skill: "Engine", status: "busy", progress: 75, rating: 4.9 },
  { id: 2, name: "Maria Garcia", skill: "Electrical", status: "available", progress: 0, rating: 4.8 },
];
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex justify-between mb-3">
                    ...
                    <Badge className={t.status === "busy" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"}>
                      {t.status}
                    </Badge>
                  </div>

                  <div className="flex gap-4 text-sm mb-3">
                    <span className="flex gap-1"><Star className="w-4 h-4 text-yellow-400" />{t.rating}</span>
                    <span className="flex gap-1"><Wrench className="w-4 h-4" />{t.skill}</span>
                  </div>
